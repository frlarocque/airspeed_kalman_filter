...
[p, z, d] = zoomPlot(kalman_res{1}.t,kalman_res{1}.z(7,:), zoom_range, [0.225 0.52 0.3875 0.38],[2 3]);
...
f = xline(fault_time+0.1,'-',{'Fault'},'linewidth',1.5*line_width,'color',mycolors(3,:),'LabelHorizontalAlignment','right','LabelVerticalAlignment','top','fontsize',font_size-4);
