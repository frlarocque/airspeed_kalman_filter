...
detection_diff = kalman_res{1}.t(find(kalman_res{1}.res_fault_detector.flag(3,:)==1,1,'first'));
...
legend(ax4,[f,d1,d2],{'Fault','Detection High','Detection Diff.'},'fontSize',font_size-4,'Location', 'northwest', 'Orientation', 'vertical');    
