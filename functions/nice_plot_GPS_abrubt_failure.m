...
d2 = xline(detection_diff,':',{'Criteria Deriv.'},'linewidth',1.5*line_width,'color',mycolors(5,:),'LabelHorizontalAlignment','left','LabelVerticalAlignment','top','fontsize',font_size-4);
