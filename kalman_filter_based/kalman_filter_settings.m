...
EKF_AW_PITOT_DETECT_CRIT_LOW = 3;
EKF_AW_PITOT_DETECT_CRIT_HIGH = 5.5;
EKF_AW_PITOT_DETECT_CRIT_DIFF = 17;

EKF_AW_PITOT_DETECT_TIME_LOW = 7;
EKF_AW_PITOT_DETECT_TIME_HIGH = 0.25;
EKF_AW_PITOT_DETECT_TIME_DIFF = 0.12;

EKF_AW_PITOT_DETECT_FILTER_FREQ = 5;

% GPS fault detection parameters
EKF_AW_GPS_DETECT_CRIT_LOW =  100;
EKF_AW_GPS_DETECT_CRIT_HIGH = 2.5;
EKF_AW_GPS_DETECT_CRIT_DIFF = 30;

EKF_AW_GPS_DETECT_TIME_LOW = 100;
EKF_AW_GPS_DETECT_TIME_HIGH = 0.08;
EKF_AW_GPS_DETECT_TIME_DIFF = 0.08;

EKF_AW_GPS_DETECT_FILTER_FREQ = 5;

% A_x fault detection parameters
EKF_AW_AX_DETECT_CRIT_LOW =  100;
EKF_AW_AX_DETECT_CRIT_HIGH = 1.25;
EKF_AW_AX_DETECT_CRIT_DIFF = 250;

EKF_AW_AX_DETECT_TIME_LOW = 100;
EKF_AW_AX_DETECT_TIME_HIGH = 2;
EKF_AW_AX_DETECT_TIME_DIFF = 0.08;

EKF_AW_AX_DETECT_FILTER_FREQ = 0.1;
