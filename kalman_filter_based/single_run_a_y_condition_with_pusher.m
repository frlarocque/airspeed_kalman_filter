...
a_y_filt = filter(b_accel_y,a_accel_y,IMU_accel.flight.data(:,2));

x_0 = [5 0 0 0 0 0]';%[0 0 0 -1.6 -4 0]';
u_list = [IMU_accel.flight.data IMU_rate.flight.data IMU_angle.flight.data]';
z_list = [Vg_NED.flight.data IMU_accel.flight.data(:,2) pusher_prop_rpm.flight.data]'; %measurement
...
R = diag([Vg_NED.var 3E10 2E10]); %measurement noise
